package com.brain.comptabilite.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("comptabilite");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("comptabilite");
        ...
        config.getMapConfigs().put("com.brain.comptabilite.domain.*", initializeDomainMapConfig(jHipsterProperties));
