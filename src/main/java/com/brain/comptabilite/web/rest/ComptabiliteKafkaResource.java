...
@RestController
@RequestMapping("/api/comptabilite-kafka")
public class ComptabiliteKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ComptabiliteKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ComptabiliteKafkaResource(KafkaProperties kafkaProperties) {
